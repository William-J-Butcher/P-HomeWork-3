...
dict_letters = {1:'AEIOULNSTRАВЕИНОРСТ', 2:'DGДКЛМПУ', 3:'BCMPБГЁЬЯ', 4:'FHVWYЙЫ', 5:'KЖЗХЦЧ', 8:'JXШЭЮ', 10:'QZФЩЪ'}
word = input("Введите слово: ").upper()
sum = 0
for letter in word:                           # для буквы в слове
    for key, value in dict_letters.items():   # для ключей и значений в словаре
        if letter in value:                   # если буква в значении
            sum += key                        # к сумме прибавить ключ
